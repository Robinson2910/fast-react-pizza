...
function Order() {
  ...
  console.log(fetcher.data); //its the same data which is retured by loader function in the route /menu
  //basically it fetcher data from another route without having to navigate to it
  ...
  return (
    <div className='space-y-8 px-4 py-6'>
      ...
      <ul className='border- divide-y divide-stone-200 border-b border-t'>
        {cart.map((item) => (
          <OrderItem
            item={item}
            key={item.pizzaId}
...
// luckily for us, React Router has, of course,
